package com.tonggu.provider.cs.cms.common.config.aop;
...
import com.tonggu.provider.cs.cms.common.util.JsonUtil;
...
public class VisitLogIntercept {
	...
	/** 打印日志与响应时间 */
	@Around("within(com.tonggu.provider.cs.cms.controller..*Controller)")
