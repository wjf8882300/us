package com.runxsports.provider.cs.cms.common.config.aop;
...
import com.runxsports.provider.cs.cms.common.util.JsonUtil;
import com.runxsports.provider.cs.cms.common.util.WebUtil;
...
public class VisitLogIntercept {
	...
	/** 打印日志与响应时间 */
	@Around("within(com.runxsports.provider.cs.cms.controller..*Controller)")
